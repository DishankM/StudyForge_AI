  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="rounded-full border border-white/10 bg-white/5 px-3.5 py-1 text-xs uppercase tracking-[0.24em] text-gray-400">
          Output Hub
        </div>
      </div>
        ...
        <div className="rounded-[26px] border border-white/10 bg-zinc-950/80 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.24)] sm:p-6">
          ...
          <div className="space-y-3">
            {document.notes.map((note: any) => (
              <div
                key={note.id}
                className="flex flex-col gap-3 rounded-2xl border border-white/5 bg-white/[0.03] p-3.5 sm:flex-row sm:items-center sm:justify-between sm:p-4"
              >
                <div>
      ...
      {hasViva && (
        <div className="rounded-[26px] border border-white/10 bg-zinc-950/80 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.24)] sm:p-6">
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-white/5 bg-white/[0.03] p-3.5 sm:flex-row sm:items-center sm:justify-between sm:p-4">
            <div>
      ...
      {!hasNotes &&
        ...
        !hasRoadmaps && (
          <EmptyState
            ...
            description="Generate notes, MCQs, viva practice, or a roadmap from this document."
            examples={["Start with notes for quick revision", "Generate MCQs for active recall", "Create viva questions for oral prep"]}
            helperText="A simple default is notes first, MCQs second, viva third, roadmap last."
